 ...
 * no service, transport, or persistence involved yet. The assertions
 * themselves live in the shared WorkspacePort conformance suite (test/support)
 * so every future adapter is held to the exact same contract.
 */
