...
// Composed from the 6 sub-concern action maps (file-ops/code-intelligence/git/mutation/symbol-graph/
// repo-cache), file-for-file mirroring service/'s own segmentation -- annotation is its own nested
