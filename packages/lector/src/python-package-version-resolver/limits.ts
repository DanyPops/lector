import type { InstalledPythonVersionBounds, InstalledPythonVersionOutcome, OversizedInstalledPythonVersion } from "./installed-package-version.ts";

export type LimitedResource = OversizedInstalledPythonVersion["resource"];
...
export function resourceLimitOutcome(error: ManifestResourceLimitExceeded, bounds: InstalledPythonVersionBounds): InstalledPythonVersionOutcome {
