 ...
 * maxResults/maxBytes is hit first -- shared by every code-intelligence/cache-detail operation
 ...
 * answers that separately). Most callers pass offset 0 -- they want one bounded page, not real
 * pagination; workspace.cacheWalkedFiles/workspace.cacheFailures are the two that use offset for
 * real paging.
 */
