...
import type { InstalledCrateVersionBounds } from "./installed-crate.ts";
...
export class RustResolutionContext {
	private bytesRead = 0;
	private entriesRead = 0;
	private diagnosticsRead = 0;
	private readonly root: string;
	readonly bounds: InstalledCrateVersionBounds;

	constructor(projectRoot: string, bounds: InstalledCrateVersionBounds) {
