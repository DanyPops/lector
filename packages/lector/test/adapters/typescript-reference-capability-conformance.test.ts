...
import type { NpmPackageCandidate } from "../../src/external-search/external-search-result.ts";
...
import type { NpmPackageVersionMetadata } from "../../src/npm-registry/npm-package-metadata.ts";
